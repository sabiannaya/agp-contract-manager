...
import type { ContractForm, VendorOption } from '@/types/models';
    ...
    saveConfirmation.requestConfirmation(
        {
            ...
            description: t('contracts.create_description'),
...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <div class="flex flex-col gap-6 p-6">
            <Heading :title="t('contracts.create')" :description="t('contracts.create_description')" />
