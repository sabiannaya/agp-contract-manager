...
const page = usePage<{ auth?: Partial<Auth> }>();
</script>
...
<template>
    ...
    >
        <header
            class="mb-6 w-full text-sm not-has-[nav]:hidden lg:"
        >
        ...
        >
            <main
                class="flex  flex-col-reverse overflow-hidden rounded-lg lg: lg:flex-row"
            >
                <div
